...
class Container {
    ...
    public get startAdapter(): StartAdapter { if (this._startAdapter)
    ...
    public get coreAudioAddTextUseCaseAddAudioTextUseCase(): CoreAudioAddTextUseCaseAddAudioTextUseCase { if (this._coreAudioAddTextUseCaseAddAudioTextUseCase)
    ...
    public get welcomeControllerController(): WelcomeControllerController { if (this._welcomeControllerController)
    ...
    public get audioViewAudioPresenter(): AudioViewAudioPresenter { if (this._audioViewAudioPresenter)
    ...
    public get startViewStartPresenter(): StartViewStartPresenter { if (this._startViewStartPresenter)
    ...
    public get coreAudioAudioService(): CoreAudioAudioService { if (this._coreAudioAudioService)
    ...
    public get coreStartStartUseCaseStartUseCase(): CoreStartStartUseCaseStartUseCase { if (this._coreStartStartUseCaseStartUseCase)
    ...
    public get startControllerController(): StartControllerController { if (this._startControllerController)
