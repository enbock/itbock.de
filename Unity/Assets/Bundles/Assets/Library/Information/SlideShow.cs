...
public class SlideShow : MonoBehaviour
{
    ...
    private string Data;
    [ReadOnly] public int CurrentImage = -1;
    ...
    void Update()
    {
        ...
        if (NextSwitchTime < 0f || NextSwitchTime < Time.realtimeSinceStartup)
        {
            ...
            FrontImages[0].sprite = Slides[nextImage];
            FrontImages[1].sprite = Slides[CurrentImage];
            BackImages[0].sprite = Slides[nextImage];
            BackImages[1].sprite = Slides[CurrentImage];
    ...
    IEnumerator LoadSlideImage(string imageUri, int index)
    {
        ...
        using (UnityWebRequest request = UnityWebRequestTexture.GetTexture(url))
        {
            ...
            else
            {
                ...
                sprite.name = imageUri + " - " + Entity.name;
                Slides[index] = sprite;
